...
public class IdemixCredRequest {
     ...
     */
    public IdemixCredRequest(final BIG sk, final BIG issuerNonce, final IdemixIssuerPublicKey ipk) {
        if (sk == null) {
     ...
     */
    IdemixCredRequest(final Idemix.CredRequest proto) {
     ...
     */
    boolean check(final IdemixIssuerPublicKey ipk) {

        if (nym == null || issuerNonce == null
            || proofC == null || proofS == null
            || ipk == null) {
            return false;
        }
