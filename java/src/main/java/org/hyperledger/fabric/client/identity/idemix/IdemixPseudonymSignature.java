...
public class IdemixPseudonymSignature {
     ...
     */
    public IdemixPseudonymSignature(final BIG sk, final IdemixPseudonym pseudonym, final IdemixIssuerPublicKey ipk, final byte[] msg) {
     ...
     */
    public IdemixPseudonymSignature(final Idemix.NymSignature proto) {
        if (proto == null) {
     ...
     */
    public boolean verify(final ECP nym, final IdemixIssuerPublicKey ipk, final byte[] msg) {
